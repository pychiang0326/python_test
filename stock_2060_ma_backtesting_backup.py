...
#     """
#     计算移动平均线和买卖信号 - 修改后的版本 20MA,60MA黃金交叉 60MA,20MA死亡交叉
#     """
#     # 修复列名问题
...
#
#         # 计算黄金交叉和死亡交叉
#         golden_cross_20_60 = (ma20 > ma60) and (ma20_prev <= ma60_prev)
#         death_cross_20_60 = (ma20 < ma60) and (ma20_prev >= ma60_prev)
#
#         # 买入条件：20MA与60MA黄金交叉且在200MA之上且未持仓
#         if golden_cross_20_60 and close_price > ma200 and not holding:
...
def plot_stock_chart(stock_data, buy_signals, sell_signals, stack_code, cumulative_returns=None):
    """
    使用matplotlib绘制股票图表
    """
    ...
    ax1.set_title(f'台积电({stack_code}) - 股价与移动平均线 (20MA/60MA交叉策略)', fontsize=16)
...
def main():
    ...
    try:
        ...
        # 绘制图表
        print("\n正在生成图表...")
        plot_stock_chart(stock_with_ma, buy_signals, sell_signals, stack_code, cumulative_returns)
